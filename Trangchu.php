<?php
	require('connect.php');
	$sql1 = "SELECT * FROM contentleft ORDER BY ID DESC ";
...
?>
		<div id="content-left">
			...
			if($_SESSION['username'] == 'admin123'){
				echo '<a href="contentleft.php"> <button type="button">Thêm Bài </button><a>';
			}
			?>
			...
			?>
			<p>
				<a href="./detailpage.php?id=<?php echo $row1["id"] ?>" target="_bank">
...
?>
		<div id="content-mid">
			...
			<?php
			if($_SESSION['username'] == 'admin123'){
				echo '<a href="contentmid.php"> <button type="button" style="background-color:red; height:50px;">Thêm Bài </button><a>';
			}
			?>
			<br />
...
?>
		...
		<div>
			<?php 
				if($num2 > 0){	
			?>
				<a href="./detailpage.php?id=<?php echo $row2["id"]?>&page=contentleft3"><strong> <?php echo $row2['tieude']?> </strong></a>
			<p>
				<?php echo $row2['noidung']?>
			</p>
		</div>
		<div>
			<a href="./detailpage.php?id=<?php echo $row2["id"]?>&page=contentleft3">
